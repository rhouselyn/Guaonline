...
export const translations = {
  zh: {
    ...
    autoTranslateHint: "如果输入文字的语言与所选语种不同，系统将自动翻译成该语种",
    translating: "翻译中...",
    generating: "生成文本中...",
  ...
  en: {
    ...
    autoTranslateHint: "If the input language differs from the selected language, it will be automatically translated",
