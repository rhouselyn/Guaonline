...
export const translations = {
  zh: {
    ...
    modeDirectPlaceholder: "粘贴或输入你想学习的文本（若语种与所选不同，将自动翻译成目标语种）...",
    modeTranslatePlaceholder: "输入你想翻译并学习的文本...",
    modeGeneratePlaceholder: "描述想学的文本内容或上传图片（可识别图中文字与情景），如：一篇关于旅行的短文...",
    autoTranslateHint: "如果选中语种与输入文字的语言不同，系统会自动翻译成该目标语种",
    translating: "翻译中...",
    generating: "生成文本中...",
    detectingLanguage: "识别语言中...",
    preparing: "准备中...",
    retryingSentences: "重试失败句子中...",
    modeLabel: "输入模式",
    confirmDelete: "确认删除",
    ...
    logoutConfirmSwitch: "切换账号将退出当前登录，是否继续？",
    apiConfig: "API 配置",
    itemsPerPage: "每页数量",
    configured: "已配置",
    ...
    noSentencesYetHint: "暂无句子，输入文本后将自动生成",
    retryInterval: "请求间隔",
    ...
    uiLangDesc: "界面语言和翻译目标语言",
    login: "登录",
    logout: "退出登录",
    unlimitedQuota: "无限额度",
    monthlyQuotaInfo: "每月 {0} 句额度",
    dailyRefillInfo: "每日恢复 {0} 句，上限 {1} 句",
    remainingQuota: "剩余额度",
    quotaInsufficient: "额度不足：需要 {0} 句，剩余 {1} 句",
    freeTier: "免费版",
    basicTier: "基础版",
    proTier: "专业版",
  ...
  en: {
    ...
    modeDirectPlaceholder: "Paste or enter text to learn (if its language differs from the selected one, it will be auto-translated to the target language)...",
    modeTranslatePlaceholder: "Enter text to translate and learn...",
    modeGeneratePlaceholder: "Describe text content to learn or upload images (text and scenes in images can be recognized), e.g.: a short essay about travel...",
    autoTranslateHint: "If the selected language differs from your input, it will be auto-translated to that target language",
    translating: "Translating...",
    generating: "Generating text...",
    detectingLanguage: "Detecting language...",
    preparing: "Preparing...",
    retryingSentences: "Retrying failed sentences...",
    ...
    ttsEdgeDesc: "Better quality, requires network",
    ttsWebSpeechDesc: "Real-time, depends on device",
    skip: "Skip",
    skipped: "Skipped",
    stepProgress: "{0} / {1}",
    ...
    logoutConfirmSwitch: "Switching account will log out the current session. Continue?",
    ...
    noSentencesYetHint: "No sentences yet, they will be generated from your text",
    ...
    onlyNewWordsDesc: "Skip words you have already learned",
    skipListeningDesc: "Skip listening exercises",
    uiLangDesc: "UI language and translation target language",
    login: "Log In",
    logout: "Log Out",
    unlimitedQuota: "Unlimited",
    monthlyQuotaInfo: "{0} sentences per month",
    dailyRefillInfo: "Daily refill {0} sentences, max {1}",
    remainingQuota: "Remaining Quota",
    quotaInsufficient: "Insufficient quota: {0} sentences needed, {1} remaining",
    freeTier: "Free",
    basicTier: "Basic",
    proTier: "Pro",
