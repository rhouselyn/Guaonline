...
class TextProcessor:
    ...
    async def process_translation(self, text: str, source_lang: str, target_lang: str, llm_api, context_sentences: dict = None, prefill_tokens=None):
        result = await llm_api.process_text_with_dictionary(text, source_lang, target_lang, context_sentences, prefill_tokens)
